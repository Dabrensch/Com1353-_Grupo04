...
BEGIN
    ...
    ELSE
	BEGIN
		IF @idLineaProducto IS NOT NULL AND (SELECT estado FROM Producto.LineaProducto WHERE idLineaProducto = @idLineaProducto) = 0
...
BEGIN
    ...
    ELSE
	BEGIN
		IF @idCategoriaProducto IS NOT NULL AND (SELECT estado FROM Producto.CategoriaProducto WHERE idCategoriaProducto = @idCategoriaProducto) = 0
...
BEGIN
    ...
    ELSE
	BEGIN
		IF @idSucursal IS NOT NULL AND (SELECT estado FROM Sucursal.Sucursal WHERE idSucursal = @idSucursal) = 0
