...
-- Resultado esperado: idNotaDeCredito = 1, idDetalleVenta = 1, motivo = 'Dañado', idProductoCambio = NULL, monto = 90 (45*2), cantidad = 2
EXEC Venta.GenerarNotaDeCredito 1, 2, 'Dañado', 0;
...
EXEC Venta.GenerarNotaDeCredito 9999, 1, 'Dañado', 0;
...
EXEC Venta.GenerarNotaDeCredito 3, 1, 'Dañado', 0;
...
EXEC Venta.GenerarNotaDeCredito 2, -1, 'Dañado', 0;

-- Prueba 6: Cantidad mayor a cantidad vendida
-- Resultado esperado: Error: "La cantidad a devolver supera la cantidad vendida."
EXEC Venta.GenerarNotaDeCredito 1, 20, 'Dañado', 0;

-- Prueba 7: Suma de cantidad de las notas de credito mayor a cantidad vendida
-- Resultado esperado: Error: "La cantidad a devolver junto con notas de crédito previas supera la cantidad vendida. "
EXEC Venta.GenerarNotaDeCredito 1, 1, 'Dañado', 0;
