...
-- Cada ejecución se realiza por sección completa, es decir, todas las pruebas relacionadas con un mismo módulo se ejecutan en conjunto antes de avanzar a la siguiente.
...
-- Esperado: Inserción exitosa.
EXEC Venta.InsertarVenta '222-22-2222', 'A', 'E', '2025-01-10', '12:30', 1200.50, 'AAA', 1, 1, 1, 1, @idVentaGenerado OUTPUT;

-- Prueba 2: Intentar insertar con tipo de factura inválido.
-- Esperado: Error 'El tipo de factura debe ser A, B o C.'
EXEC Venta.InsertarVenta '222-22-2222', 'X', 'E', '2025-01-10', '12:30', 1200.50, 'AAA', 1, 1, 1, 1, @idVentaGenerado OUTPUT;

-- Prueba 3: Intentar insertar con total <= 0.
-- Esperado: Error 'El total debe ser mayor a 0.'
EXEC Venta.InsertarVenta '222-22-2222', 'A', 'E', '2025-01-10', '12:30', -1200.50, 'AAA', 1, 1, 1, 1, @idVentaGenerado OUTPUT;

-- Prueba 4: Intentar insertar una factura con Nro invalido.
-- Esperado: Error: 'El Nro de factura no es valido, debe ser xxx-xx-xxxx. '
EXEC Venta.InsertarVenta '22222', 'A', 'E', '2025-01-10', '12:30', 1200.50, 'AAA', 1, 1, 1, 1, @idVentaGenerado OUTPUT;

-- Prueba 5: Insertar un detalle de venta válido.
-- Esperado: Inserción exitosa.
EXEC Venta.InsertarDetalleVenta @idVentaGenerado, 1, 1, 1;

-- Prueba 6: Intentar insertar cantidad negativa.
-- Esperado: Error 'La cantidad debe ser mayor a 0.'
EXEC Venta.InsertarDetalleVenta @idVentaGenerado, 1, -1, 1;

-- Prueba 7: Intentar insertar precio unitario negativo.
