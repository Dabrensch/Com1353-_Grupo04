...
BEGIN
    ...
    BEGIN
        ...
        EXEC Cliente.InsertarCliente '23-38947562-4', 'Lucía', 'Fernández', '3333333333', 'Female', 'Normal';
        EXEC Cliente.InsertarCliente '25-31784950-7', 'Julián', 'Pereyra', '4444444444', 'Male', 'Normal';
    END
END;
GO
