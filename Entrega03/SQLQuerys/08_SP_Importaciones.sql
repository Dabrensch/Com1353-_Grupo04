...
BEGIN	
	...
	BEGIN TRY
		...
		EXEC sp_executesql @CargaDatosArchivo, N'@RutaArchivo NVARCHAR(1024)', @RutaArchivo;
...
BEGIN
	...
	EXEC sp_executesql @SQL, N'@Directorio NVARCHAR(500), @NombreArchivo NVARCHAR(100)', @Directorio, @NombreArchivo;
...
BEGIN
	...
	BEGIN
		...
		EXEC sp_executesql @SQL, N'@RutaArchivo NVARCHAR(100)', @RutaArchivo;
...
BEGIN
	...
	EXEC sp_executesql @Consulta, N'@RutaArchivo NVARCHAR(100)', @RutaArchivo;
    ...
    SET 
        ...
        p.descripcionCantidad = t.CantidadPorUnidad,
    ...
    INSERT INTO Producto.Producto (nombre, precio, descripcionCantidad, idCategoriaProducto)
...
BEGIN
	BEGIN TRY
		...
		BEGIN TRANSACTION;
			...
			EXEC sp_executesql @CargaDatosArchivo, N'@RutaArchivo NVARCHAR(100)', @RutaArchivo;
